...
void createKKT_U(spmat* Gt, spmat* At, cone* C, idxint** S, spmat** K, idxint* AttoK, idxint* GttoK);

pfloat lineSearch(pfloat* lambda, pfloat* ds, pfloat* dz, pfloat tau, pfloat dtau, pfloat kap, pfloat dkap, cone* C, kkt* KKT);

pfloat lineSearch(pfloat* lambda, pfloat* ds, pfloat* dz, pfloat tau, pfloat dtau, pfloat kap, pfloat dkap, cone* C, idxint nrhs);
}
}
