...
(
    ...
    mfloat Control [ ],	/* array of size AMD_CONTROL */
    mfloat Info [ ]	/* array of size AMD_INFO */
)
{
 ...
 *
 * Control:  A mfloat array of size AMD_CONTROL containing input parameters
 ...
 *
 * Info:  A mfloat array of size AMD_INFO.  If present, (that is, not NULL),
 ...
 * ----------------------------------------------------------------------------
 * LOCAL mfloatS, used for statistical output only (except for alpha):
 * ----------------------------------------------------------------------------
 */

    mfloat f, r, ndiv, s, nms_lu, nms_ldl, dmax, alpha, lnz, lnzme ;
