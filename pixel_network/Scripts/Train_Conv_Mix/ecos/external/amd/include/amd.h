...
(
    ...
    mfloat Control [ ],        /* input Control settings, of size AMD_CONTROL */
    mfloat Info [ ]            /* output Info statistics, of size AMD_INFO */
) ;
 ...
 *       Control:  a mfloat array of size AMD_CONTROL, containing control
 ...
 *       Info: a mfloat array of size AMD_INFO, containing statistical
...
void amd_defaults   (mfloat Control [ ]) ;
void amd_l_defaults (mfloat Control [ ]) ;

/* amd_control: prints the control settings */
void amd_control    (mfloat Control [ ]) ;
void amd_l_control  (mfloat Control [ ]) ;

/* amd_info: prints the statistics */
void amd_info       (mfloat Info [ ]) ;
void amd_l_info     (mfloat Info [ ]) ;
