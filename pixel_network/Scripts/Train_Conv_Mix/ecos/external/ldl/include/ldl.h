...
int ldl_numeric2 (int n, int Ap [ ], int Ai [ ], mfloat Ax [ ],
    int Lp [ ], int Parent [ ], int Sign[], mfloat eps, mfloat delta, int Lnz [ ], int Li [ ], mfloat Lx [ ],
    mfloat D [ ], mfloat Y [ ], int Pattern [ ], int Flag [ ]
#if PROFILING > 1
     ,mfloat *t1, mfloat *t2
#endif
                  ) ;

void ldl_lsolve (int n, mfloat B [], int Lp [ ], int Li [ ], mfloat Lx [ ]) ;
void ldl_lsolve2 (int n, mfloat B [], int Lp [ ], int Li [ ], mfloat Lx [ ], mfloat X [ ]) ;

void ldl_dsolve (int n, mfloat X [ ], mfloat D [ ]) ;

void ldl_ltsolve (int n, mfloat X [ ], int Lp [ ], int Li [ ],
    mfloat Lx [ ]) ;
...
SuiteSparse_long ldl_l_numeric2 (SuiteSparse_long n, SuiteSparse_long Ap [ ],
    SuiteSparse_long Ai [ ], mfloat Ax [ ], SuiteSparse_long Lp [ ],
    SuiteSparse_long Parent [ ], SuiteSparse_long Sign [ ], mfloat eps, mfloat delta, SuiteSparse_long Lnz [ ],
    SuiteSparse_long Li [ ], mfloat Lx [ ], mfloat D [ ], mfloat Y [ ],
...
void ldl_l_lsolve (SuiteSparse_long n, mfloat B [ ], SuiteSparse_long Lp [ ], SuiteSparse_long Li [ ], mfloat Lx [ ]) ;
void ldl_l_lsolve2 (SuiteSparse_long n, mfloat B [ ], SuiteSparse_long Lp [ ], SuiteSparse_long Li [ ], mfloat Lx [ ], mfloat X [ ]) ;

void ldl_l_dsolve (SuiteSparse_long n, mfloat X [ ], mfloat D [ ]) ;

void ldl_l_ltsolve (SuiteSparse_long n, mfloat X [ ], SuiteSparse_long Lp [ ],
    SuiteSparse_long Li [ ], mfloat Lx [ ]) ;
