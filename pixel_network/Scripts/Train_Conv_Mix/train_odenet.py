...
import odenet_utils as odenet
from train_utils import count_parameters,print_layer_parameters
from train_odenet_utils import train_model,eval_model,load_model
...
if ctx['eval']=='none': # train
    train_model(dataloaders,net,opt,start_epoch,ctx)
else:
    eval_model(dataloaders[ctx['eval']],net,cp['epoch']-1,ctx)