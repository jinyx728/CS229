...
def camera_ray(gt_mesh, pd_mesh, camera_pos, back_vtx):
    ...
    for i in range(len(pdv)):
        ...
        # intersect
            ...
            # DEBUG: save intersect as point cloud
    ...
    # DEBUG: output intersect point cloud
    # with open('../model_15129/point_cam2.obj', 'w') as out:
    #     for intersect in intersects:
    #         out.write("v {} {} {}\n".format(intersect[0], intersect[1], intersect[2]))
...
if __name__ == "__main__":
    ...
    if len(args.camera) != 3:
        ...
        exit(1)
    texcoord_est(args.groundtruth, args.predict, args.camera, args.back)
